# Tienda EXPRESS
Este es un proyecto de ecommerce que se utiliza para el curso de React en CoderHouse. La aplicación permite ver una lista de productos de indumentaria masculina y femenina y realizar compras en línea. Los productos y las órdenes de compra se almacenan en Firebase.
